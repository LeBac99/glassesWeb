@include('member/includes/header')
  ...
  <div>
    <div class="headerbn">
      ...
      <h1 class="header-title" style="font-size: 50px;">Các sản phẩm liên quan đến từ khóa @if (isset($searchText))
          "{{$searchText}}"
      @endif</h1>
    </div>
  </div>
  <main>
    ...
    <div class="product-list-container">
          @if (isset($product_by_search) && count($product_by_search)>0)
        <div id="product-list">
              @foreach ($product_by_search as $item)
              <div class="product">
